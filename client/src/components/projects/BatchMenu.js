...
const BatchMenu = (props)=> {
    ...
    const clickedBatch =(e) =>{
        ...
        if(e.currentTarget.id===e.target.id){
            ...
            props.getSelectedBatch(e.target.id)
        }
    }
        ...
        <div className="batch-flex-container">
            <div className="batch-list">
                <div className="batch-header-container">
                    <h5 className="batch-header">Batches</h5>
                ...
                <div className="add-batch-container">
                    <form onSubmit={addBatch}>
                        ...
                        <Button className="add-batch-button" type="submit" variant ="contained" color="primary" >Add</Button>
                    </form>
                </div>
            </div>
            <div className = "batch-parts-container">
                <BatchContent selectedBatch = {selectedBatch} reRenderBatch={props.reRenderBatch}/>
            </div>
        </div>
    )
}
